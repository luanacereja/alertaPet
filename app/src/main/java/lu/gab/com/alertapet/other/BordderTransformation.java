package lu.gab.com.alertapet.other;
...
/**
 * Created by Lu on 24/06/2017.
 */

public class BordderTransformation extends BitmapTransformation {

    public BordderTransformation(Context context) {
        super(context);
    }
    ...
    protected Bitmap transform(BitmapPool pool, Bitmap bmp, int outWidth, int outHeight) {
       ...
       //paint.setColor(Color.RED);
        ...
        stroke.setStrokeWidth(2f); //border width
